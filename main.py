        """
        Fixture Builder 5g2lrcf1
        ========================
        Data engineering tool to transform structured datasets with zero hassle.
...
from pathlib import Path
        ...
        APP_NAME    = "Fixture Builder 5g2lrcf1"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Data engineering tool to transform structured datasets with zero hassle.")
